...
<body class="bg-gray-800 p-6">
    <div class="max-w-lg mx-auto bg-gray-900 p-6 rounded-lg shadow-md">
        <h1 class="text-4xl font-bold mb-2 text-center text-white">Edit Pegawai</h1>
        <p class="text-gray-400 mb-4 text-center">Edit Data Pegawai</p>
        ...
        <form name="formEdit" method="POST" action="">
            ...
            <?php foreach ($rows as $row): ?>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="nomor_induk" name="nomor_induk" class="mt-1 block w-full border border-gray-600 bg-gray-800 text-white rounded-md shadow-sm focus:ring focus:ring-blue-500" value="<?php echo $row['nomor_induk']; ?>" required />
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="bagian" name="bagian" class="mt-1 block w-full border border-gray-600 bg-gray-800 text-white rounded-md shadow-sm focus:ring focus:ring-blue-500" value="<?php echo $row['bagian']; ?>" required />
                </div>
                <div class="mb-4">
 ...
 <option value="KAWIN">KAWIN</option>
                ...
                <div class="mb-4">
                    ...
                    <input type="date" id="tmt" name="tmt" class="mt-1 block w-full border border-gray-600 bg-gray-800 text-white rounded-md shadow-sm focus:ring focus:ring-blue-500" value="<?php echo $row['tmt']; ?>" required />
                </div>
            <?php endforeach; ?>
